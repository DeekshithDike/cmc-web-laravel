        ...
        <form method="POST" action="{{ route('customer.withdrawals.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" name="amount" value="{{ old('amount') }}" required class="w-full h-11 pl-9 pr-3 rounded-xl bg-subtle border border-border text-sm text-text focus:outline-none focus:border-primary">
                </div>
            </div>
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="wallet_address" value="{{ old('wallet_address') }}" required placeholder="0x…" class="w-full h-11 pl-9 pr-3 rounded-xl bg-subtle border border-border text-sm text-text focus:outline-none focus:border-primary font-mono">
                </div>
