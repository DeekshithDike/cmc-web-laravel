...
return [
    ...
    */
    ...
    'nowpayments' => [
        ...
        'pay_currency' => strtolower(env('NOWPAYMENTS_PAY_CURRENCY', 'usdtbsc')),
        'payout_currency' => strtolower(env('NOWPAYMENTS_PAYOUT_CURRENCY', 'usdtbsc')),
        'payout_currency_trc20' => strtolower(env('NOWPAYMENTS_PAYOUT_CURRENCY_TRC20', 'usdttrc20')),
        'payout_currency_bep20' => strtolower(env('NOWPAYMENTS_PAYOUT_CURRENCY_BEP20', env('NOWPAYMENTS_PAYOUT_CURRENCY', 'usdtbsc'))),
