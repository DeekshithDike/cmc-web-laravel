...
<p class="text-sm text-muted text-center mt-1">Sign in to your <?php echo e(config('citymax.name')); ?> account</p>

<?php echo $__env->make('partials.alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<form class="space-y-4 mt-6" method="POST" action="<?php echo e(route('customer.login.submit')); ?>">
    <?php echo csrf_field(); ?>
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" id="login_id" name="login_id" value="<?php echo e(old('login_id')); ?>" required autofocus autocomplete="username" placeholder="Your member ID"
...
<?php echo $__env->make('layouts.customer-guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Freelancing\Projects\MLM\26\App\cmc-web-laravel\resources\views/customer/auth/login.blade.php ENDPATH**/ ?>