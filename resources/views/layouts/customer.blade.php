...
<head>
    ...
    <link href="{{ asset('customer-assets/css/crypto-ui.css') }}?v={{ @filemtime(public_path('customer-assets/css/crypto-ui.css')) ?: '1' }}" rel="stylesheet">
    @stack('styles')
</head>
    ...
    <div class="flex items-center justify-between h-full gap-2 px-3 sm:px-4 lg:px-6">
        <div class="flex items-center gap-2 min-w-0">
            ...
            <div class="min-w-0">
                ...
                <p class="hidden md:block text-[11px] text-muted truncate">{{ config('citymax.name') }} · crypto member desk</p>
            </div>
        </div>
