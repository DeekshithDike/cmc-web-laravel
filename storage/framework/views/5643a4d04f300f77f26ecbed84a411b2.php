...
<?php endif; ?>
<?php if(session('info')): ?>
    <div class="alert alert-info mb-4 rounded-2xl border border-primary/30 bg-primary/10 text-heading px-4 py-3 text-sm" role="alert"><?php echo e(session('info')); ?></div>
<?php endif; ?>
