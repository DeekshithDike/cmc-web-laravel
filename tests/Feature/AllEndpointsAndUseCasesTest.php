...
class AllEndpointsAndUseCasesTest extends TestCase
{
    ...
    public function test_admin_can_open_every_admin_page(): void
    {
        ...
        foreach ([
            ...
            route('admin.customers.dashboard', $this->root),
            route('admin.customers.tree', $this->root),
            route('admin.customers.withdrawals.history', $this->root),
            route('admin.customers.income.history', $this->root),
