...
<head>
    ...
    <link href="{{ asset('admin-assets/css/citymax-admin.css') }}" rel="stylesheet">
    @stack('styles')
</head>
<body>
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="{{ request()->routeIs('admin.users.create') ? 'active' : '' }}">
                    <a href="{{ route('admin.users.create') }}"><i class="fa fa-user-plus"></i> <span class="nav-label">Add New User</span></a>
                </li>
                ...
                <li class="{{ request()->routeIs('admin.power.activate') ? 'active' : '' }}">
                    <a href="{{ route('admin.power.activate') }}"><i class="fa fa-user"></i> <span class="nav-label">Activate Power ID</span></a>
                </li>
                <li class="{{ request()->routeIs('admin.withdrawals.*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="{{ route('admin.withdrawals.index', 'processing') }}">Processing</a></li>
                        <li><a href="{{ route('admin.withdrawals.index', 'completed') }}">Completed</a></li>
                        <li><a href="{{ route('admin.withdrawals.index', 'declined') }}">Declined</a></li>
                    </ul>
                </li>
                <li class="{{ request()->routeIs('admin.business.*') ? 'active' : '' }}">
                    <a href="#"><i class="fa fa-bar-chart"></i> <span class="nav-label">Business Details</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="{{ route('admin.business.all') }}">All Users Business</a></li>
                        <li><a href="{{ route('admin.business.offer') }}">Offer Business</a></li>
                    </ul>
                </li>
                <li class="{{ request()->routeIs('admin.renewals.*') ? 'active' : '' }}">
                    <a href="#"><i class="fa fa-refresh"></i> <span class="nav-label">Manage Renewals</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="{{ route('admin.renewals.active') }}">Active Users</a></li>
                        <li><a href="{{ route('admin.renewals.renewed') }}">Renewed Users</a></li>
                        <li><a href="{{ route('admin.renewals.expired') }}">Expired Users</a></li>
                    </ul>
                </li>
                <li class="{{ request()->routeIs('admin.password.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.password.edit') }}"><i class="fa fa-key"></i> <span class="nav-label">Change Password</span></a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom:0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <form method="POST" action="{{ route('admin.logout') }}" class="m-t-sm m-r-md">
                            @csrf
